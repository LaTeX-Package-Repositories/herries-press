...
\author{Peter Wilson, Herries Press; \\ maintained by \LaTeX\ Team\\
{\small\url{https://github.com/LaTeX-Package-Repositories/herries-press}}}
...
\item[v1.2] New maintainer (\LaTeX\ Team): Tagging support.
\end{description}
